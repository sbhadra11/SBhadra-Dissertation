...
\centering(\textit{Figure~\ref{#1} follows on the next page.})
\end{minipage}
}
...
\include{ch2-pastwork/chapter-pastwork}
\include{ch3-dbb/chapter-dbb}
\include{ch4-bw/chapter-bw}
\include{ch5-alkbw/chapter-alkbw}
\include{ch6-conclusion/chapter-conclusion}
\appendix % all chapters following will be labeled as appendices
\include{ch-appendices/eis}
\include{ch-appendices/fulldata}
